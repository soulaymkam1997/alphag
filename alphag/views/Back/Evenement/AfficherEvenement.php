            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">List Evenement</h4>
                                ...
                                <table id="ejemplo" class="table table-striped table-bordered" style="width:100%">
                                    ...
                                    {    ?>
                                        <tr>
                                            ...
                                            <td><img  style="  width:100px; height:100px; " src="http://localhost/Alphag/views/Back/Evenement/uploads/<?php echo $row['photo'] ?>"></td>
                                            <td> <form action="./SupprimerEvenement.php">  <input type="hidden" name="id" value="<?php echo $row['id'] ?>"> <input type="submit" value="Supprimer" name="submit">  </form></td>
                                        </tr>
                                    <?php }
                                    ?>
